(ns puppetlabs.puppetdb.query.latest-events
  "SQL/query-related functions for latest-events"
...
(defn default-select
  ...
  [(format
    "SELECT %s
         FROM latest_events
         JOIN reports ON latest_events.report_id = reports.id

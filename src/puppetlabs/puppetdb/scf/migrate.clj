...
(defn rededuplicate-facts []
  (log/info (trs "[1/7] Creating new fact storage tables..."))
  (jdbc/do-commands
   "CREATE SEQUENCE fact_values_id_seq;"
  ...
  (log/info (trs "[2/7] Copying unique fact values into fact_values"))
  (jdbc/do-commands
  ...
  ;; query plan
  (log/info (trs "[3/7] Reconstructing facts to refer to fact_values..."))
  (jdbc/do-commands
  ...
  (log/info (trs "[4/7] Computing fact value hashes..."))
  ...
  (log/info (trs "[5/7] Indexing fact_values table..."))
  (jdbc/do-commands
   "DROP TABLE facts"
   "ALTER TABLE facts_transform rename to facts"
  ...
  (log/info (trs "[6/7] Cleaning orphaned facts"))
  (jdbc/do-commands
